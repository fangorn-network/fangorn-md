...
Welcome. This page links back to the [home page](index.md).
...
Links defined in the markdown files induce a graph structure that is extracted when publishing to Fangorn (vertices = pages, edges = links). To publish, just click publish on the top right.